...
from backend.agents.zhangxuefeng.prompt import build_system_prompt
...
async def stream_answer(question: str, session_id: str = "default-session") -> AsyncIterator[str]:
    ...
    """
    import asyncio
    from backend.agents.zhangxuefeng.search import search_fresh_data
    from backend.agents.zhangxuefeng.memory import add_exchange, build_history_context
